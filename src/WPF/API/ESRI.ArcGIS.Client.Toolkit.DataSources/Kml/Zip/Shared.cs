...
namespace ESRI.ArcGIS.Client.Toolkit.DataSources.Kml.Zip
{
    ...
    internal class SharedUtilities
    {
		...
		static System.Text.Encoding ibm437 = System.Text.Encoding.Unicode; //Was: IBM437
        ...
        internal static DateTime PackedToDateTime(Int32 packedDateTime)
        {
            ...
            if (day <= 0) { day = 1; } // ArcGIS server returns 0x0020 as date : not sure of the meaning (winzip displays the current date)
